...
- [x] Ajouter et réussir le test contractuel du retrait propriétaire d’une demande RGPD pending (18 tests ciblés).
- [x] Afficher dans Settings l’état final d’une demande RGPD approuvée, refusée ou annulée avant de proposer une nouvelle action (9 tests Settings/RGPD ciblés réussis).
- [x] Ajouter une assertion UI garantissant que Settings ne présente pas une nouvelle demande lorsque le dernier état RGPD est traité (8 tests RGPD/Settings ciblés réussis).
...
- [ ] Lot global : auditer et renforcer les permissions par ressource dans les modules critiques — CRM, finances, achats et opérations projets couverts ; autres ressources restantes à auditer.
...
- [x] Lot global : documenter l’architecture, les API tRPC et les rôles/permissions ; références publiées dans `docs/`.
...
- [x] Ajouter un registre de notes de frais avec justificatif, déplacement, statut et remboursement.
- [x] Exposer la validation et le remboursement des notes de frais avec permissions et audit.
- [x] Ajouter une vue Finance des notes de frais en attente avec tests de transition d’état.
