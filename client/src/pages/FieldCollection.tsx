...
export default function FieldCollection() {
  ...
  const [antenneFilter, setAntenneFilter] = useState("");
  ...
  const filteredItems = useMemo(() => items.filter((item) => item.antenne.toLowerCase().includes(antenneFilter.toLowerCase())), [items, antenneFilter]);
  const save = () => {
